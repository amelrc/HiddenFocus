					...
					>
						<Container style={{ flexDirection: 'row' }}>
							...
							>
								<div>
									<p>
										I began taking "portraits" of flowers in the Spring of
										2019.  By summer, they had grown into a body of work called
										"Look at the Flowers..." and, in the fall, became the
										subject of four local exhibits (insert link to Shows/Look at
										the Flowers).  As winter unfolded, I began to wonder what
										would show up through the lens come Spring.  Would the 2020
										blossoms look the same?
									</p>
									<p>
										"Homage to Monet" appeared on the first photo-shoot of
										Spring, and radiated the answer: the possibilities, even
										within the confines of my small garden, are infinite. 
									</p>
									<p>
										The visual feel of this image and of others soon to follow
										is decidedly watercolor.  Since the distinctive medium for
										all these images is light, I've settled on a new name to
										describe them: "Lightscapes."
									</p>
								</div>
								<ImageSlider slides={EnescuData} />
							</div>
						</Container>
						<Container>
