...
import { SubHeaderOne } from './styles';

export const SubHeaderTwo = (
	<>
		<SubHeaderOne>2nd Concert</SubHeaderOne>
		<h3>Eglinton St. George’s United Church, Toronto</h3>
...
export const PageOne = {
	name: 'Unknow',
	page: [
		{ id: 1, image: W2169, css: { width: '16%', margin: 10 } },
		{ id: 2, image: W0900, css: { width: '40%', margin: 10 } },
		{ id: 3, image: W0789, css: { width: '26%', margin: 10 } },
		{ id: 4, image: W0563, css: { width: '20%', margin: 10 } },
		{ id: 5, image: W0241, css: { width: '20%', margin: 10 } },
		{ id: 6, image: W2555, css: { width: '20%', margin: 10 } },
	],
};
export const PageTwo = {
	name: SubHeaderTwo,
	page: [
		{ id: 1, image: W2421, css: { width: '20%', margin: 10 } },
		{ id: 2, image: W1384, css: { width: '40%', margin: 10 } },
		{ id: 3, image: W0403, css: { width: '20%', margin: 10 } },
		{ id: 4, image: W0291, css: { width: '20%', margin: 10 } },
		{ id: 5, image: W8251, css: { width: '20%', margin: 10 } },
		{ id: 6, image: W0769, css: { width: '20%', margin: 10 } },
	],
};
export const PageThree = {
	name: 'Unknow',
	page: [
		{ id: 1, image: W7897, css: { width: '15%', margin: 10 } },
		{ id: 2, image: W2613, css: { width: '40%', margin: 10 } },
		{ id: 3, image: W8175, css: { width: '15%', margin: 10 } },
		{ id: 4, image: W0831, css: { width: '22%', margin: 10 } },
		{ id: 5, image: W1669, css: { width: '22%', margin: 10 } },
		{ id: 6, image: W8110, css: { width: '22%', margin: 10 } },
	],
};
